import code.MyArray_651304;
import code.MyArrayBasic_651304;
class L3_ArrayTester_Main {
    ...
    static private void arrayBasic_demo1() {
        MyArrayBasic_651304 demo = new MyArrayBasic_651304(7,6,8,1,2,3);
        System.out.println(demo);
    }
    static private void arrayBasic_demo2() {
        MyArrayBasic_651304 demo = new MyArrayBasic_651304();
        demo.insert(9, 0);
        demo.insert(7,0);
        demo.insert(5,0);
        System.out.println(demo);
    ...
    static private void arrayBasic_demo3() {
        MyArrayBasic_651304 demo = new MyArrayBasic_651304(null);
    ...
    static private void myArray_demo4() {
        MyArray_651304 demo = new MyArray_651304(5);
        demo.delete(0);
        demo.add(3);
        demo.add(7);
        demo.add(5);
    ...
    static private void task2() {
        for (int N = 200_000; N <= 10 * 200_000; N += 200_000) {
            ...
            MyArray_651304 mArray = new MyArray_651304(N);
        ...
        for (int N = 200_000; N <= 10 * 200_000; N += 200_000) {
            long start = System.currentTimeMillis();
            MyArray_651304 mArray = new MyArray_651304();
            for (int n = 1; n <N; n++)
                mArray.add((int)(Math.random()*1000));
            long time = (System.currentTimeMillis() - start);
            System.out.println(N + "\t\t" + time);
